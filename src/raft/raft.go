...
func (rf *Raft) AppendEntries(args *AppendEntriesArgs, reply *AppendEntriesReply) {
	...
	if args.PrevLogIndex > currentLogLength-1 || rf.Logs[args.PrevLogIndex].Term != args.PrevLogTerm {
